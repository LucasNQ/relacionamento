      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="flex flex-col-reverse md:grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          <div className="text-center md:text-left">
            <h2 className="text-[41px] md:text-[64px] leading-[49.2px] tracking-[2.5px] md:leading-[64px] md:tracking-[2.5px] font-black mb-4 md:mb-6">
            ...
            <p className="text-lg md:text-[24px] leading-snug md:leading-[30px] text-gray-300 mb-6">
