    ...
    <section className="relative py-20 md:py-32 bg-black">
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="space-y-8 mb-16">
          {/* Card 1 */}
          <div className="bg-[#0A0A0A] border-t-2 border-b-2 border-red-600 rounded-2xl p-8 text-center shadow-[0_0_15px_rgba(237,0,42,0.2)] md:w-[70%] md:mx-auto">
            <h3 className="font-bebas text-[34px] leading-[40.8px] md:text-[42px] md:leading-[42px] tracking-[2.5px] uppercase text-white mb-4">
              <span className="text-[#ED002A]">BÔNUS 1:</span> O SEGREDO DA MASSAGEM ERÓTICA QUE ENLOUQUECE QUALQUER MULHER! <span className="text-[#ED002A]">- DE <span className="line-through">R$ 197,00</span> POR R$0,00</span>
            </h3>
          ...
          <div className="bg-[#0A0A0A] border-t-2 border-b-2 border-red-600 rounded-2xl p-8 text-center shadow-[0_0_15px_rgba(237,0,42,0.2)] md:w-[70%] md:mx-auto">
            <h3 className="font-bebas text-[34px] leading-[40.8px] md:text-[42px] md:leading-[42px] tracking-[2.5px] uppercase text-white mb-4">
              <span className="text-[#ED002A]">BÔNUS 2:</span> LEITURA FRIA: A ARTE DE LER A ALMA DELA SEM ELA PERCEBER! <span className="text-[#ED002A]">- DE <span className="line-through">R$ 147,00</span> POR R$0,00</span>
            </h3>
            <p className="text-gray-300 leading-relaxed max-w-4xl mx-auto">
