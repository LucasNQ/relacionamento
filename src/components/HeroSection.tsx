...
export default function HeroSection() {
  ...
  return (
    <section className="relative w-full min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div
        ref={elementRef}
        className={`relative z-10 max-w-5xl mx-auto px-6 pt-32 pb-20 text-center opacity-0 ${isVisible ? 'animate-slide-up' : ''}`}
      >
        <h1 className="text-[30px] leading-[30px] tracking-[1.5px] md:text-[60px] font-black md:leading-[60px] text-[#ED002A] uppercase md:tracking-[2.5px]" >
