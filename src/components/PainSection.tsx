    ...
    <section className="relative pt-20 pb-0 md:py-32 bg-black overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        <div className="max-w-2xl">
          <div className="space-y-8 text-base leading-snug md:text-[20px] md:leading-[24px]">
      ...
      <div className="hidden md:block absolute bottom-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-red-600 to-transparent z-10" />
    </section>
  );
}
